FROM ubuntu:14.04
MAINTAINER Kai-Hsun Chen <kevin8542170040@gmail.com>
...
RUN apt-get update && \
    apt-get install -y wget \
		       ...
		       rsync \
                       ...
                       make
# Compile hadoop
COPY hadoop-2.7.1-src /opt/hadoop-2.7.1-src
RUN cd /opt/hadoop-2.7.1-src && mvn package -Pdist -Dtar -DskipTests
RUN cd /opt \
    && tar xvzf hadoop-2.7.1-src/hadoop-dist/target/hadoop-2.7.1.tar.gz \
